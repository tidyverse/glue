...
- [`glue_data()`](https://glue.tidyverse.org/dev/reference/glue.md)
  [`glue()`](https://glue.tidyverse.org/dev/reference/glue.md) : Format
  and interpolate a string
...
- [`identity_transformer()`](https://glue.tidyverse.org/dev/reference/identity_transformer.md)
...
- [`single_quote()`](https://glue.tidyverse.org/dev/reference/quoting.md)
  ...
  Quoting operators
- [`trim()`](https://glue.tidyverse.org/dev/reference/trim.md) : Trim a
  character vector
