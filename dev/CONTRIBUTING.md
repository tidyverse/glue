...
This outlines how to propose a change to glue. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("batpigandme/glue", fork = TRUE)`.
...
of Conduct](https://glue.tidyverse.org/dev/CODE_OF_CONDUCT.md). By
