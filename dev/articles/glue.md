...
[`glue()`](https://glue.tidyverse.org/dev/reference/glue.md) can be used
to glue together pieces of text:
...
[`glue()`](https://glue.tidyverse.org/dev/reference/glue.md) honors the
line breaks in its input:
...
you have [`glue()`](https://glue.tidyverse.org/dev/reference/glue.md)
inside a function body (this example also has an alternative placement
...
the literal `\n` escape sequences.
[`glue()`](https://glue.tidyverse.org/dev/reference/glue.md) and friends
...
By default, [`glue()`](https://glue.tidyverse.org/dev/reference/glue.md)
...
So, for a top-level
[`glue()`](https://glue.tidyverse.org/dev/reference/glue.md) call, that
...
[`glue()`](https://glue.tidyverse.org/dev/reference/glue.md) in
`name = value` form:
...
Returning to
[`glue()`](https://glue.tidyverse.org/dev/reference/glue.md), recall
that it defaults to evaluation in the caller environment. This has happy
implications inside a
...
[`glue()`](https://glue.tidyverse.org/dev/reference/glue.md) call:
...
[`glue()`](https://glue.tidyverse.org/dev/reference/glue.md) and get
unexpected “object not found” errors, read
[`vignette("wrappers", package = "glue")`](https://glue.tidyverse.org/dev/articles/wrappers.md)
...
[`glue_sql()`](https://glue.tidyverse.org/dev/reference/glue_sql.md) can
be used in conjunction with parameterized queries using
...
[`glue_sql()`](https://glue.tidyverse.org/dev/reference/glue_sql.md) can
be used to build up more complex queries with interchangeable sub
queries. It returns
[`DBI::SQL()`](https://dbi.r-dbi.org/reference/SQL.html) objects which
are properly protected from quoting.
