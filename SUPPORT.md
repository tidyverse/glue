...
Thanks for using glue! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/batpigandme/glue/issues/new).
...
requests](https://github.com/batpigandme/glue/issues) to make sure the
