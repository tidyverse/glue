...
[`glue()`](https://glue.tidyverse.org/reference/glue.md) makes it easy
to interpolate data into strings:
...
is an alias for
[`glue::glue()`](https://glue.tidyverse.org/reference/glue.md). So if
...
These [`glue_data()`](https://glue.tidyverse.org/reference/glue.md)
examples also demonstrate that
[`glue()`](https://glue.tidyverse.org/reference/glue.md) is vectorized
over the data.

### What you see is awfully close to what you get

[`glue()`](https://glue.tidyverse.org/reference/glue.md) lets you write
code that makes it easy to predict what the final string will look like.
There is considerably less syntactical noise and mystery compared to
...
[`glue()`](https://glue.tidyverse.org/reference/glue.md) is used inside
...
[`glue_data()`](https://glue.tidyverse.org/reference/glue.md) shown
here. More recommended functions and resources:

- The “Get started” article
  ([`vignette("glue")`](https://glue.tidyverse.org/articles/glue.md))
...
- “How to write a function that wraps glue”
  ([`vignette("wrappers")`](https://glue.tidyverse.org/articles/wrappers.md))
...
- glue provides a couple of custom knitr engines that allow you to use
  ...
  [`vignette("engines")`](https://glue.tidyverse.org/articles/engines.md).
